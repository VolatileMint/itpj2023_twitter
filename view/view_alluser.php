...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="search">
            <form class="form-inline my-2 my-lg-0" action="userlist.php" method="get">
                <input name="search" class="form-control mr-sm-2" type="search" placeholder="ユーザーの検索" aria-label="Search">
